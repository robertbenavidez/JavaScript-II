...
runners.map(function(runner){
    allCaps.push(`${runner.first_name.toUpperCase()} ${runner.last_name.toUpperCase()}`)
})
console.log(allCaps); 
...
/*
let ticketPriceTotal = runners.reduce(function(sum, donated ) {
    return sum + donated.donation
}, 0);
*/
// arrow function version
let ticketPriceTotal = runners.reduce((sum, donated) => sum + donated.donation , 0);
